              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="needs-validation" method="POST" action="tu_archivo_php.php" enctype="multipart/form-data">
                    <div class="mb-4">
                      <!-- Eliminado el label y se establece un valor predeterminado -->
                      <input type="text" name="nombre_punto" class="form-control" id="nombre_instalacion" value="San Francisco" required>
                    </div>
                    ...
                    <div class="col-12 mt-4">
                      <!-- Cambiando el texto del botón a "Editar" -->
                      <button class="btn btn-primary w-100" type="button" id="editarBtn">Editar</button>
                    </div>

                    <script>
                      document.getElementById("editarBtn").addEventListener("click", function() {
                        // Aquí puedes agregar la lógica para enviar el formulario de edición
                        // window.location.href = "tu_script_de_edicion.php";
                        window.location.href = "../../../cuentas/back/bienvenida/back/welcome.php";
